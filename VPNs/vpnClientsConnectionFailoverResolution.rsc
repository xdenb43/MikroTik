...
#    wg-bth - Mikrotik Back-To-Home via relay
...
# Target Scope for recursive route MUST be greater than next hope route targetr scope value
/ip route
add comment="proton recursive routing" disabled=no distance=21 dst-address=0.0.0.0/0 gateway=77.88.8.2 routing-table=any_vpn_out scope=30 suppress-hw-offload=no \
    target-scope=11
add comment="proton recursive routing" disabled=no distance=20 dst-address=0.0.0.0/0 gateway=77.88.8.2 routing-table=geo_vpn_out scope=30 suppress-hw-offload=no \
    target-scope=11
add comment="warp recursive routing" disabled=no distance=20 dst-address=0.0.0.0/0 gateway=1.1.1.3 routing-table=any_vpn_out scope=30 suppress-hw-offload=no \
    target-scope=11
add comment=bth disabled=no distance=21 dst-address=0.0.0.0/0 gateway=192.168.216.1 routing-table=geo_vpn_out scope=30 suppress-hw-offload=no target-scope=10
add comment=bth disabled=no distance=22 dst-address=0.0.0.0/0 gateway=192.168.216.1 routing-table=any_vpn_out scope=30 suppress-hw-offload=no target-scope=10
add check-gateway=ping comment="proton monitor external ip" disabled=no distance=20 dst-address=77.88.8.2/32 gateway=10.2.0.1 routing-table=main scope=10 \
